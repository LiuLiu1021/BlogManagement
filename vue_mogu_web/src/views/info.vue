  ...
  <article>
    ...
    <h1 class="t_nav">
      ...
      <a
        ...
        @click="goToSortList(blogData.labels[0])"
        class="n2"
      >{{blogData.labels[0] ? blogData.labels[0]:""}}</a>
    </h1>
    <div class="infosbox">
      <div class="newsview">
...
<!--        </div>-->
      ...
      <!--付款码和点赞-->
      <LikeAndCollect v-if="openAdmiration === '1'" :blogUid="blogUid" :praiseCount="blogData.likeCount"></LikeAndCollect>
